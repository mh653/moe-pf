...
export default function Header() {
  ...
  return (
    <>
      <header className="font-heading bg-background3 text-fc2 overflow-hidden flex justify-between pl-[3vw] pr-8 items-center z-100 fixed bottom-0 left-0 w-screen h-[40px]
        ...
        <div className="text-center relative lg:mt-15 lg:mb-20 2xl:mt-20 2xl:mb-25">
            ...
            lg:w-[33px] lg:h-[33px] 2xl:w-[35px] 2xl:h-[35px]"></div>
        </div>
        <nav className="pl-[10vh] lg:pl-0">
          ...
          <div onClick={() => setIsMenuOpen(!isMenuOpen)} className="h-[18px] w-[24px] relative md:hidden">
      ...
      <nav>
        <ul className={`fixed bottom-[30px] z-50 bg-background4 text-fc2 w-screen h-[300px] py-4 flex flex-col items-center justify-around 
          md:hidden 
