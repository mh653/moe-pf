        ...
        >
          <div className="border border-gray1 bg-background2 rounded-[15px] h-full">
            <a href={work.vercelUrl} target="blank">
              <div className="h-[210px] mt-5 overflow-hidden">
                <Image
                  src={work.image}
            ...
            <div className="p-5 2xl:-mt-5">
              <div className="flex justify-between">
                ...
                hover:bg-background2 hover:text-fc1 transition-colors duration-300 2xl:-mr-1">
                  <a href={work.gitUrl} target="blank"><FaGitAlt size={22}/></a>
                </div>
              </div>
              <div>
                {work.tools.map((tool, i) => (
                    <span key={i} className="bg-gray1 px-2 pb-[1px] rounded-full text-gray2 text-xs mr-1">
                    {tool}
                    </span>
                ))}
              </div>
